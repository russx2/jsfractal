...
var JSF_History = new Class({
   ...
   add: function(obj_plane_coords, obj_canvas_coords) {
       ...
       elm_thumb.getContext('2d').drawImage(this.elm_canvas, 0, 0, 300, 300, 0, 0, 50, 50);
   ...
   set_active: function(int_history_idx) {
       ...
       var arr_history = $(this.str_history_id).getElements('canvas').removeClass('active');
   ...
   get_active: function() {
       return this.arr_history[this.int_active_idx];
   },
